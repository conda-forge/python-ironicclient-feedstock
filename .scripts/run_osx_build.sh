...
validate_recipe_outputs "python-ironicclient-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="python-ironicclient-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi